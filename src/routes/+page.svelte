  ...
  <div class="flex w-full items-center justify-between gap-1">
    ...
    <div class="p-1 py-5">
      <img
        src="/me.png"
        alt="BlankParticle"
        class="size-20 -rotate-12 select-none drama-fuchsia-600/80 drama-20 spring-bounce-40 spring-duration-500 hover:rotate-0 hover:drama-5 md:size-32 md:drama-28"
      />
    </div>
  </div>
